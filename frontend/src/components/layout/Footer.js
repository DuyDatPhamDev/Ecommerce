            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  ...
                  <p className="text">Website bán hàng trực tuyến của AnhDatStore, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>Số xxx xxx Da Nang</li>
                      <li>AnhDatStore</li>
                      <li>info@AnhDatStore.com</li>
                      <li>+012 3456 7890</li>
                    </ul>
                  </div>
                  {/* End Single Widget */}
              ...
              <div className="row">
                <div className="col-lg-12 col-12">
                  <div className="text-center">
                    <p>Copyright © 2023 By Nhóm AnhDat</p>
                  </div>
                </div>
